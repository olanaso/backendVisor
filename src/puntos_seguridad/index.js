...
function crearGrilla() {
    ...
    $("#grid").jqGrid({
        ...
        colModel: [
            ...
            {
                name: 'idpuntos_seguridad',
                index: 'idpuntos_seguridad',
                editable: false,
                align: "center",
                width: 80,
                search: false,
...
window.edit2 = function (rowid, id) {
    ...
    for (var i = 1; i <= rowIds.length; i++) {
        ...
        if (rowData.idpuntos_seguridad === id.toString()) {
...
function actualizar(button) {
    ...
    $.ajax({
        ...
        url: "/api/puntos_seguridad",
        data: {
            idpuntos_seguridad:$('body').data("id"),
